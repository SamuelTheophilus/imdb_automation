...
- `tag_text` extraction more reliable, leading to better image grouping
...
- With only 31-32 matched pairs vs. 45 GT products, many products simply could not be evaluated.
...
- GPT-5.5 does **not** support `max_tokens`; use `max_completion_tokens`
...
4. **Cost:** Anthropic Batch API at 50% discount makes full evals roughly 2x cheaper than GPT-5.5 standard
